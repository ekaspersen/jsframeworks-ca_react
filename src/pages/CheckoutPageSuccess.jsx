...
function CheckoutPageSuccess() {
    return (
        <div className="flex flex-col text-center px-4">
            <span className="shopping-page_h1">Success.exe</span>
            <p>
                Thanks very much for shopping here at this very legit store.
                Stuff you ordered is toootally on its way to the adress and
                payment info you filled in, yes.
            </p>
            <Link to="/">
                <div className="continue-shopping flex justify-center my-10 items-center gap-4 underline underline-offset-4 ">
